...
def system():
    ...
    def Database():
        ...
        # creating bill table
        cursor.execute("CREATE TABLE IF NOT EXISTS Restaurantrecords(ordno text, ac_yes text, piz text,bur text,ice text, dr text, ct text,sb text,tax text,sr text,tot text, mem text)")
